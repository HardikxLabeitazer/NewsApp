...
export class MainTop extends Component {
    ...
    update =async ()=>{
        const url=`https://newsapi.org/v2/top-headlines?country=in&apiKey=6afdc30f902148d0a74db6e2ddddd83d&page=1`
    ...
    render() {
        ...
        return (
            <div className='container text-center mainpage' >
                {/* <div className='sidebars s1'>
                    <h5>Previous Day News</h5>
                ...
                <div className='container mainhead'>
                    <h1 className='my-2'>Today's HeadLine</h1>
                    <div className='container my-4 text-center'><h3>{this.state.articles[0].title}</h3></div>
                    <img style={{ border: "solid 1px blue" }} className="mx-3 my-4" src={this.state.articles[0].urlToImage} alt="imag" />
                </div>

                {/* <div>
                    <h5 className='sidebars s2'>Upcoming Events</h5>
                    <div className="card cardcheck" >
